...
function addCart(){
	...
	$(".addCart").click(function(evt){
			//获取端口Id
			var $gid = $(this).parents(".item").attr('data-good-id');
			//获取名称
			var $gRemark = $(this).parents(".list_intr").children(".title").text();
			//获取价格
			var $goodPrice = parseInt($(this).siblings('span').html());
			//获取src
